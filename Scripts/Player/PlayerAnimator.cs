...
namespace AustinController 
{
    ...
    public class PlayerAnimator : MonoBehaviour 
    {
        ...
        void Update() 
        {
            ...
            // Run Forward
            if (_player.Input.X != 0) _anim.SetBool(RunForwardKey, true);
            else
            {
                _anim.SetBool(RunForwardKey, false);
            }
            //Debug.Log(_player.Input.X);
        ...
        private static readonly int RunForwardKey = Animator.StringToHash("RunForward");
